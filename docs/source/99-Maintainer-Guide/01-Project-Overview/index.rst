...
All package metadata and dependencies live in `pyproject.toml <https://github.com/jkhukgy/junzheng_demo-project/blob/main/pyproject.toml>`_. You never need to call ``uv`` directly — ``mise run inst`` handles it for you.
...
- `codecov.yml <https://github.com/jkhukgy/junzheng_demo-project/blob/main/codecov.yml>`_ — Codecov reporting configuration
- `.coveragerc <https://github.com/jkhukgy/junzheng_demo-project/blob/main/.coveragerc>`_ — coverage measurement settings
...
------------------------------------------------------------------------------
Documentation is built with `Sphinx <https://www.sphinx-doc.org>`_ from source files in `docs/source/ <https://github.com/jkhukgy/junzheng_demo-project/tree/main/docs/source>`_ and hosted automatically on `Read the Docs <https://readthedocs.org>`_.

The hosting config lives in `.readthedocs.yml <https://github.com/jkhukgy/junzheng_demo-project/blob/main/.readthedocs.yml>`_ — push to ``main`` and your docs update automatically. No manual deploys needed.
...
------------------------------------------------------------------------------
Continuous integration runs on GitHub Actions, configured in `.github/workflows/main.yml <https://github.com/jkhukgy/junzheng_demo-project/blob/main/.github/workflows/main.yml>`_.
